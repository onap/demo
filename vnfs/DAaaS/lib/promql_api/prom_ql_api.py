...
# def query_range():
#     QUERY_API_VERSION = '/api/v1/query_range'
#     list_of_result_sets = []
#     list_of_substrings = []
#     MAP_ENV_VARIABLES['DATA_ENDPOINT']='http://127.0.0.1:9090'
#     list_of_substrings.append(MAP_ENV_VARIABLES['DATA_ENDPOINT'])
#     list_of_substrings.append(QUERY_API_VERSION)
#     url = ''.join(list_of_substrings)
#     params_map = {}
#     params_map['query'] = 'up'
#     params_map['start'] = '2019-06-19T20:10:30.781Z'
#     params_map['end'] = '2019-06-20T20:10:30.781Z'
#     params_map['step'] = '15s'
#     print(params_map)
#     response = requests.get(url, params=params_map)
#     print(response.json())
