...
import (
	...
	onapv1alpha1 "prometheus-remote-config-operator/pkg/apis/onap/v1alpha1"
...
func (r *ReconcilePrometheusRemoteEndpoint) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set PrometheusRemoteEndpoint instance as the owner and controller
...
func newPodForCR(cr *onapv1alpha1.PrometheusRemoteEndpoint) *corev1.Pod {
