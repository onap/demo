...
#./ves_heartbeat_reporter <FQDN>|<IP address> <port> <FQDN>|<IP address> <port>
...
./ves_heartbeat_reporter $DCAE_COLLECTOR_IP $DCAE_COLLECTOR_PORT $DCAE_COLLECTOR_IP2 $DCAE_COLLECTOR_PORT2
