...
DMAAPBC_AAF_URL=https://aaf.simpledemoonap.org:8095/proxy/
DMAAPBC_MR_CNAME=dmaap.simpledemo.onap.org
DMAAPBC_DRPROV_FQDN=drps.simpledemo.onap.org
!EOF
...
DBCL_FQDN=localhost
DRPS_FQDN=drps.simpledemo.onap.org
MR_FQDN=dmaap.simpledemo.onap.org
