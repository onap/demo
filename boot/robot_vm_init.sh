...
docker pull $NEXUS_DOCKER_REPO/openecomp/testsuite
docker rm -f openecompete_container
docker run -d --name openecompete_container -v /opt/eteshare:/share -p 88:88 $NEXUS_DOCKER_REPO/openecomp/testsuite
