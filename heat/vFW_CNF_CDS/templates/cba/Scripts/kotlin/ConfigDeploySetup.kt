            ...
            if (executionRequest.name == "config-deploy-setup") {
                ...
                for (module in modulesSdnc) {
                    ...
                    if (label != null) {
                        ...
                        moduleData.put(K8sConfigTemplateComponent.INPUT_K8S_TEMPLATE_NAME, "ssh-service-config")
                        moduleData.put(K8sConfigValueComponent.INPUT_K8S_RB_CONFIG_NAME, "ssh-service-config")
